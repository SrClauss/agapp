  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const projectData: ProjectCreateData = {
        ...
        category: typeof params.project.category === 'string' ? { main: params.project.category, sub: '' } : params.project.category,
        location,
      ...
      // Update the project
      const resolvedId = params.project.id || (params.project as any)._id;
      if (!resolvedId) {
        Alert.alert('Erro', 'ID do projeto ausente. Não é possível atualizar.');
        throw new Error('missing project id');
      }
      await updateProject(resolvedId, projectData);
      ...
      if (axios.isAxiosError(error)) {
        console.error('[updateProject] axios error status:', error.response?.status);
        console.error('[updateProject] axios error data:', error.response?.data);
        console.error('[updateProject] axios error headers:', error.response?.headers);
      }

      let message = 'Não foi possível atualizar o projeto. Tente novamente.';
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerTextContainer}>
              ...
              <Text style={styles.headerSubtitle}>
                {typeof params.project.category === 'string' ? params.project.category : params.project.category.main + ' › ' + params.project.category.sub}
              </Text>
            </View>
          </View>
