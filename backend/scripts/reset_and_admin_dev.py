#!/usr/bin/env python3
"""
Script para resetar completamente o banco de dados e manter apenas o admin - VERSÃO DESENVOLVIMENTO.

Uso:
    cd /home/claus/src/agapp/backend
    source venv/bin/activate
    python scripts/reset_and_admin_dev.py
...
MONGO_URL = os.getenv('MONGODB_URL', 'mongodb://root:AGar1401al2312@localhost:27017/agiliza?authSource=admin')
...
def main():
    print("=" * 50)
    print("RESETANDO BANCO DE DADOS - MANTENDO APENAS ADMIN (DEV)")
    print("=" * 50)
